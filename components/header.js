...
export function renderHeader() {
  return `
    <header class="app-header fixed top-0 right-0 h-[68px] z-30 glass border-b border-white/[.06] flex items-center gap-3 px-4 md:px-6">
...
export function renderSearchDropdown() {
  return `
    <div id="search-dropdown" class="hidden fixed top-[68px] app-search-offset right-0 z-30 px-4 md:px-6 pt-3">
