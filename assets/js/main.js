...
import { renderSidebar, updateSidebarActive, initSidebarInteractions } from "../../components/sidebar.js";
import { renderHeader, renderSearchDropdown } from "../../components/header.js";
import { renderCard, renderListRow, bindCardEvents } from "../../components/card.js";
...
/* ============================= EVENT DELEGATION ============================= */
// bindCardEvents kini didefinisikan sekali di components/card.js dan dipakai
// bersama oleh main.js maupun player-page.js (lihat import di atas).

/* ============================= GLOBAL SEARCH ============================= */
// Wiring search bar (input, dropdown, klik-di-luar-untuk-tutup, Escape) kini
// tinggal di assets/js/global-search.js supaya bisa dipakai ulang di
// player.html juga — lihat pemanggilan initGlobalSearch() di boot().

function bindGlobalEvents() {
  // getChannels dipanggil setiap kali user mengetik, bukan sekali di awal,
  // supaya tetap akurat walau dipanggil sebelum loadCatalog() selesai.
  initGlobalSearch(() => allChannels);
