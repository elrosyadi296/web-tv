...
import { renderSidebar, initSidebarInteractions } from "../../components/sidebar.js";
...
document.getElementById("shell-sidebar").innerHTML = renderSidebar("", { hrefPrefix: "index.html" });
...
let player;
// Sama seperti main.js: disimpan di variabel modul supaya search bar bisa
// membaca daftar channel terkini lewat closure, walau baru terisi setelah
// loadCatalog() selesai (lihat initGlobalSearch di bawah).
let channels = [];

// Pasang search bar SEKARANG (bukan menunggu init()), sama seperti di
// index.html — sebelumnya ini tidak pernah dipanggil di halaman player
// sehingga search bar tampil tapi tidak merespons input apa pun.
initGlobalSearch(() => channels);
